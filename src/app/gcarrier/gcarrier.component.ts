...
export class GcarrierComponent implements OnInit {
  ...
  gcform2: FormGroup = new FormGroup ({
    ...
    Diabetes_yes: new FormControl(false),
    Diabetes_no: new FormControl(false),
    Heart_Problems_yes: new FormControl(false),
    Heart_Problems_no: new FormControl(false),
    High_Blood_Pressure_yes: new FormControl(false),
    High_Blood_Pressure_no: new FormControl(false),
    Ovarian_Cysts_yes: new FormControl(false),
    Ovarian_Cysts_no: new FormControl(false),
    Uterine_Fibroids_yes: new FormControl(false),
    Uterine_Fibroids_no: new FormControl(false),
    Thyroid_Problems_yes: new FormControl(false),
    Thyroid_Problems_no: new FormControl(false),
    ...
    legal_cases_yes: new FormControl(false),
    legal_cases_no: new FormControl(false),
    restraining_yes: new FormControl(false),
    restraining_no: new FormControl(false),
    divorce_yes: new FormControl(false),
    divorce_no: new FormControl(false),
